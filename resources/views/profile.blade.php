              ...
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                  ...
                  <div class="d-flex align-items-start flex-column justify-content-center">
                    <h6 class="mb-0 text-sm">Rendi</h6>
                    <p class="mb-0 text-xs">Ijin Pak, Untuk Project ...</p>
                  </div>
                ...
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                  ...
                  <div class="d-flex align-items-start flex-column justify-content-center">
                    <h6 class="mb-0 text-sm">Putri</h6>
                    <p class="mb-0 text-xs">Reporting untuk Pemasangan</p>
                  </div>
                  <a class="btn btn-link pe-3 ps-0 mb-0 ms-auto" href="javascript:;">Reply</a>
                </li>
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                  ...
                  <div class="d-flex align-items-start flex-column justify-content-center">
                    ...
                    <p class="mb-0 text-xs">Untuk pemasangan perangkat mengalami kendala</p>
                  </div>
                  <a class="btn btn-link pe-3 ps-0 mb-0 ms-auto" href="javascript:;">Reply</a>
                </li>
              </ul>
